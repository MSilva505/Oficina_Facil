...
# Exemplo:
# from forms import EditProfileForm  ain dentro # Importe o form de edição de perfil, se estiver em um arquivo separado.
...
from database import listar_oficinas, adicionar_oficina
from config import Config
...
@app.route('/oficinas/add', methods=['POST'])
def add_oficina():
    nome = request.form['nome']
    endereco = request.form['endereco']
    telefone = request.form['telefone']
    email = request.form['email']
    adicionar_oficina(nome, endereco, telefone, email)
